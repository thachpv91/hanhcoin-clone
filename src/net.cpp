...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hanhcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"hanhcointools.com", "dnsseed.hanhcointools.com"},
    {"hanhcoinpool.org", "dnsseed.hanhcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"hanhcointools.com", "testnet-seed.hanhcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hanhcoin is probably already running."), addrBind.ToString().c_str());
        else
